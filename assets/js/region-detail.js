...
const regionAdditionalContent = {
  ...
  nagoya: {
    spots: [['長久手', '動畫世界的森林散步', '以愛知的森林與場景為背景，適合安排完整一天慢慢探索吉卜力公園。'], ['名古屋港', '移動與工業的歷史', '從港區博物館與工業設施認識名古屋與中部地區的製造文化。']],
  ...
  'ise-shima': {
    spots: [['伊勢內宮前', '參道旁的老街散步', '在伊勢神宮內宮前沿著御蔭橫丁散步，尋找地方工藝、伴手禮與傳統小吃。'], ['二見浦', '夫妻岩與海岸信仰', '在海岸看夫妻岩與鳥居，感受伊勢志摩獨特的海洋信仰風景。']],
...
if (detailItems.length) {
  ...
  const regionalVenueData = {
    ...
    nagoya: {
      spots: {'名古屋站': [['名古屋城', '尾張歷史與金鯱文化的代表城郭。', '由名城線名古屋城站步行前往。']], '熱田': [['熱田神宮', '名古屋市中心的重要神社與森林參道。', '由名鐵神宮前站步行前往。']], '榮': [['中部電力 MIRAI TOWER', '以久屋大通與展望台為主軸的名古屋城市地標。', '由榮站步行前往。']]},
    ...
    'ise-shima': {
      spots: {'伊勢': [['伊勢神宮 內宮', '伊勢志摩最核心的參拜景點。', '由伊勢市站搭乘巴士前往。']], '志摩': [['橫山展望台', '俯瞰英虞灣與島嶼群的展望台。', '由賢島站搭乘巴士或自駕前往。']], '鳥羽': [['鳥羽水族館', '展示豐富海洋生物的鳥羽代表景點。', '由鳥羽站步行前往。']]},
